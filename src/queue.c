...
static void push_high_task(strm_queue * q, struct strm_queue_task *t)
{
...
static void push_low_task(strm_queue * q, struct strm_queue_task *t)
{
    pthread_mutex_lock(&q->mutex);
    if (q->fi) {
        q->fi->next = t;
...
struct strm_queue_task *strm_queue_task(strm_task * task,
                                        strm_callback func,
                                        strm_value data)
{
